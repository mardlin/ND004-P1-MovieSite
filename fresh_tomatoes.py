# import the webbrowser module in order to open the browser w/ webbrowser.open
import webbrowser
# import the os module to access the file system with os.path.abspath
import os
# import the re module to use regular expressions for finding youtube IDs
import re
...
# this string is a template containing a placeholder {movie_tiles} which we 
# can use to insert our customized content
main_page_content = '''
<!DOCTYPE html>
<html lang="en">
  <body>
